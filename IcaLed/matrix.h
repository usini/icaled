...
void initMatrix() {
  ...
  matrix.displayScroll(curMessage, PA_LEFT, scrollEffect, SCROLLDELAY);

  matrixManager.attach_ms(10, matrixUpdate); //Use ticker to asynchronously control the Matrix
}
